...
<
    string UIName = "Transparent Texture";
    string ResourceType = "2D";
>;
...
float4 MyPixelShader(VS_OUTPUT IN, uniform bool FogEnabled): SV_Target
{
    ...
    OUT.a = TransparentTexture.Sample(ColorSampler, IN.TextureCoordinate).a;
    if (FogEnabled)
    {
...
technique10 AlphaBlendingFogEnabled 
{
    pass p0
    {
...
technique10 AlphaBlendingFogDisabled 
{
    pass p0
    {
